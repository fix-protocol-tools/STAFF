...
public class TcpStopTask extends Task {
    ...
    public void execute() throws BuildException {
        try {
            if (refid == null) {
                throw new Exception("Reference to Tcp processor is not specified");
            }
            ...
            if (obj instanceof ITcpProccesor) {
                ((ITcpProccesor) obj).close();
            } else {
                throw new Exception("Tcp processor type is unknown");
            }
        } catch (Exception e) {
