...
public final class IntrospectionHelper {
     ...
     * @throws org.apache.tools.ant.BuildException if the introspected class doesn't support
...
//                            log.error(StackTraceUtil.getStackTrace(e));
     ...
     *                Must not be <code>null</code>.
     * @throws org.apache.tools.ant.BuildException if non-whitespace text is provided and no
     ...
     * @throws org.apache.tools.ant.BuildException if the parent does not support child elements of that name
     */
     ...
     * @throws org.apache.tools.ant.BuildException if no method is available to create the
     ...
     * @see org.apache.tools.ant.DynamicElement
     * @see org.apache.tools.ant.DynamicElementNS
     * @since Ant 1.6.3
     */
     ...
     * @throws org.apache.tools.ant.BuildException if the storage method fails.
     */
    ...
    /**
     * Helper method to extract the inner fault from an {@link java.lang.reflect.InvocationTargetException}, and turn
     ...
     * @throws org.apache.tools.ant.BuildException if the introspected class does not
     ...
     * <li>Boolean/boolean
     * ({@link org.apache.tools.ant.Project#toBoolean(String) Project.toBoolean(String)} is used)
     ...
     * {@link org.apache.tools.ant.types.EnumeratedAttribute#setValue(String) setValue} method)
