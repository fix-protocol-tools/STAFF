...
public class TestCompareHeader extends AbstractAllocInstructTestCase {
    ...
    public void testCompareHeaderField8Failed() throws Exception {
        ...
        Message fixMsg = new Message();
        fixMsg.getHeader().setString(0, FIX_4_0);
        fixMsg.getHeader().setString(35, MES_TYPE);

        final FixMessageType fixEtanolMessage = new FixMessageType();
        fixEtanolMessage.addField(new FixMessageType.Field("8", FIX_4_0));
        comparator.setModel(fixEtanolMessage);
    ...
    public void testCompareHeaderField35() throws Exception {
        ...
        final FixMessageType fixEtanolMessage = new FixMessageType();
        fixEtanolMessage.addField(new FixMessageType.Field("8", FIX_4_0));
        fixEtanolMessage.addField(new FixMessageType.Field("35", MES_TYPE));
        comparator.setModel(fixEtanolMessage);
