...
%JAVA_BIN% -classpath %CLASSPATH% %JAVA_OPTS% org.apache.tools.ant.launch.Launcher %* -cp "%STAFF_HOME_DIR%\lib\staff-ant-annotations.jar;%STAFF_HOME_DIR%\lib\staff-core.jar;%STAFF_HOME_DIR%\config"
